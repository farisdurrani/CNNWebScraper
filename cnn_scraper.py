...
# optional, to measure time elapsed
...
# @param politics_month_soup the page soup of the site hosting all the articles
# of the month of that topic
...
# @returns latest general article number to be updated globally
